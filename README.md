...
```
$ s2i build https://github.com/jurginsve/httpd-ex centos/httpd-24-centos7 myhttpdimage
...
`$ oc new-app centos/httpd-24-centos7~https://github.com/jurginsve/httpd-ex`

You can also deploy the sample template for the application:

`$ oc new-app -f https://raw.githubusercontent.com/jurginsve/httpd-ex/master/openshift/templates/httpd.json`
